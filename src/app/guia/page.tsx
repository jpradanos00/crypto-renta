...
const BREADCRUMB_SCHEMA = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Guía para descargar CSV",
      "item": "https://cryptorenta.app/guia",
    },
  ],
};
      ...
      <main className="min-h-screen px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">{t("guia.subtitle")}</p>
          </div>

          <div className="rounded-lg border border-warning/30 bg-warning/10 p-4 text-sm text-warning">
            <p className="font-medium">
              &#9888;&#65039; {t("guia.warningTitle")}
            </p>
            <p className="mt-1">{t("guia.warningBody")}</p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="aspect-video w-full overflow-hidden rounded-lg border border-border">
                  <iframe
                    ...
                    title="Tutorial: Cómo descargar el CSV de transacciones de Coinbase"
